...
var file_pkg_proto_auth_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x38, 0x0a, 0x08,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x31, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	0x75, 0x6c, 0x6c, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x5e, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73,
...
var file_pkg_proto_auth_proto_depIdxs = []int32{
	...
	0, // 1: auth.RegisterResponse.response:type_name -> auth.Response
	2, // 2: auth.RegisterResponse.user:type_name -> auth.User
	0, // 3: auth.LoginResponse.response:type_name -> auth.Response
	0, // 4: auth.AuthenticateResponse.response:type_name -> auth.Response
	...
	7, // 10: auth.AuthService.Authenticate:output_type -> auth.AuthenticateResponse
